...
SQUAD_STAKING_PACKAGE=furya-squad-staking
BREEDING_PACKAGE=furya-breeding
DISTRIBUTOR_PACKAGE=furya-distributor
...
publish.backend:
	docker build -f go/cmd/furya-dapp-backend/Dockerfile .  --platform amd64 -t $(BACKEND_DOCKER_IMAGE)
