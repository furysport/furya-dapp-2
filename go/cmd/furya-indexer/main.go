...
import (
	...
	"github.com/FURYA/furya-dapp/go/internal/indexerhandler"
	"github.com/FURYA/furya-dapp/go/pkg/pricespb"
	"github.com/FURYA/furya-dapp/go/pkg/quests"
...
func main() {
	...
	var (
		...
		squadStakingContactAddressV1   = fs.String("the-riot-squad-staking-contract-address-v1", "", "address of the furya squad staking contract V1")
		squadStakingContactAddressV2   = fs.String("the-riot-squad-staking-contract-address-v2", "", "address of the furya squad staking contract V2")
