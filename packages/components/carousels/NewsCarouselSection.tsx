...
import defaultFurypunkPNG from "../../../assets/default-images/default-furypunk-nft.png";
import chevronLeftSVG from "../../../assets/icons/chevron-left.svg";
import chevronRightSVG from "../../../assets/icons/chevron-right.svg";
import tnsPNG from "../../../assets/logos/furya-name-service.png";
...
export const NewsCarouselSection: React.FC = () => {
  ...
  const gorillaNavigate = useNavigateToCollection(
    "furya-furya1999u8suptza3rtxwk7lspve02m406xe7l622erg3np3aq05gawxsrh9g0p"
  );
  ...
  const fakeNews: News[] = [
    ...
    },
    {
      ...
      subtitle:
        "An original collection from the Sunnyside Reapers featuring stunning new art: exclusively on Furya",
      text:
        "These 666 succubi are here to bring a world of pleasure to Furya. \n" +
        "\n" +
    ...
    {
      title: "JOIN THE R!OT",
      subtitle: "Discover the first NFT project on Furya",
      text:
        "The R!ot is the first NFT project on Furya Network. This collection tells the story of the members of The R!ot battling The Legion Club through a complete lore and P2E mechanics.\n" +
        "\n" +
        "In addition to this, this collection is closely linked to the Furya Hub and grants its holders the possibility to access Furya features in early access.",
      image: defaultGuardianPNG,
      button1Label: "Marketplace",
      button2Label: "Discover",
      button1Action: () => {
        navigation.navigate("Collection", {
          id: "furya-furya1mf6ptkssddfmxvhdx0ech0k03ktp6kf9yk59renau2gvht3nq2gqg87tkw",
        });
      },
      button2Action: () => {
    ...
    },
    {
      ...
      subtitle: "Introducing the FuryPunks",
      text:
        "The FuryPunks are invading Furya and the least we can say is that they did not come empty-handed.\n" +
        "\n" +
        "If you like to play games & earn rewards, you’re at the right place. Mint is coming soon on the launchpad.",
      image: defaultFurypunkPNG,
      button1Label: "Marketplace",
      button2Label: "Discover",
      button1Action: () => {
        navigation.navigate("Collection", {
          id: "furya-furya1plr28ztj64a47a32lw7tdae8vluzm2lm7nqk364r4ws50rgwyzgsapzezt",
        });
      },
      button2Action: () => {
        Linking.openURL("https://twitter.com/FuryPunks");
      },
    },
    {
      title: "BOOK YOUR HANDLE",
      subtitle: "Check out Furya Name Service",
      text:
        "Furya Name Service is a way for you to affirm your identity as a Furyaan. TNS are NFTs that can be used throughout the Furya dApp and of course you can also sell them on the Marketplace.\n" +
        "\n" +
        "More Name Services will be added to TNS over time so stay on the lookout for the next updates.",
      image: tnsPNG,
      button1Label: "Furya Name Service",
      button1Action: () => {
    ...
    },
    {
      ...
      text:
        ...
        "- An XP bonus for Game of Furya Season 2.\n" +
