...
export const THE_RIOT_COLLECTION_ID = `furya-${THE_RIOT_COLLECTION_ADDRESS}`;

export const THE_RIOT_BREEDING_CONTRACT_ADDRESS =
  process.env.THE_RIOT_BREEDING_CONTRACT_ADDRESS || "";

export const FURYA_DISTRIBUTOR_CONTRACT_ADDRESS =
  process.env.FURYA_DISTRIBUTOR_CONTRACT_ADDRESS || "";
